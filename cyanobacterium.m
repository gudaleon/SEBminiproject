classdef cyanobacterium
    ...
    properties (Constant)
        GrowthRate = 2;             % Baseline growth rate of the cyanobacterium
        ...
        nvp = 9;                    % The number of continuous variable to be modelled with ODEs
        ...
        fCimport = 0.5;             % Constant of fC import into cells
        Pleak = 0.0029;             % Constant of P leakage from cells
        Pimport = 0.3;              % Constant of P import into cells
    ...
    methods (Static) 
        function cyanobacterium = construct(I, P, hR, DF, sN, fN, Ph, sC, fC, pS, hN, L, GP)
        ...
        function cyanobacterium = differentiate(cyanobacterium)
            ...
            cyanobacterium.HetR = cyanobacterium.HetR - 0.1;
        end
    end
end
