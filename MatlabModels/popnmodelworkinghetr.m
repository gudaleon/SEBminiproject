function [dydt] = popnmodelworkinghetr(t, y, latitude, Gsc, P_influx)
...
% Species 2:
dydt(1) = a*(C2/(C2 + k))*H2 - rN*V2*Z2 - rNN*(V2+H2)*(N2/(kNN + N2));                                  % N2
...
dydt(6) = P_influx - 2*b*(Pext/(Pext + kPext))*V2; %-2*b*(Pext/(Pext + kPext))*V2;
