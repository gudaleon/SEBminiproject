function [dydt] = popnmodelworking(t, y, latitude)
...
% Parameters
rN = 15e-2;     % Rate of nitrogen consumption
rC = 60e-2;     % Rate of carbon consumption
rP = 1e-2;     % Rate of phosphate consumption
a = 0.075;
...
dydt(5) = 0.06 - 2*b*(Pext/(Pext + kPext))*V1; %-2*b*(Pext/(Pext + kPext))*V2;
